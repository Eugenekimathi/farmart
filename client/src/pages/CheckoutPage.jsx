...
import { placeOrder, startPayment, pollPaymentStatus, resetCheckout, markPaymentFailed } from '../features/orders/ordersSlice'
  ...
  const handlePayment = async () => {
    ...
    if (result.meta.requestStatus === 'fulfilled') {
      ...
      paymentTimeoutRef.current = setTimeout(() => {
        if (pollRef.current) clearInterval(pollRef.current)
        dispatch(markPaymentFailed('Payment timed out. Please try again.'))
      }, 60000)
    }
  }
            ...
            <div>
              ...
              <div className="mpesa-box">
                ...
                <div className="form-group" style={{ marginTop: '1rem' }}>
                  <label className="form-label" htmlFor="mpesa-phone">M-Pesa Phone Number</label>
                  <input
                    id="mpesa-phone"
                    type="tel"
                    value={mpesaPhone}
