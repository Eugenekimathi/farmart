...
const CartPage = () => {
  ...
  if (!isLoading && error) {
    return (
      <div className="cart-empty cart-empty--error">
        <h2 className="cart-empty__title">We could not load your cart</h2>
        <p className="cart-empty__subtitle">{error}</p>
  ...
  return (
    <div className="cart-page">
      ...
      {error && <div className="cart-page__notice" role="status">{error}</div>}
