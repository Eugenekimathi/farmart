  ...
  return (
    <aside className="filter-sidebar">
      ...
      <div className="filter-group">
        <label className="filter-group__label">Animal Type</label>
        <select name="animal_type" value={filters.animal_type} onChange={handleFilterChange} className="filter-group__select">
      ...
      <div className="filter-group">
        ...
        <select name="breed" value={filters.breed} onChange={handleFilterChange} className="filter-group__select">
      ...
      <div className="filter-group">
        <label className="filter-group__label">Max Age (months)</label>
        <select name="age" value={filters.age} onChange={handleFilterChange} className="filter-group__select">
